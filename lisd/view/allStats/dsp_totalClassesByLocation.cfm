...
<div id="totalClassesByLocation" style="width: 820px;">
<script type="text/javascript">
	//Syntax: var uniquevar=new animatedcollapse("DIV_id", animatetime_milisec, enablepersist(true/fase), [initialstate] )
	var collapse4=new animatedcollapse("totalClassesByLocation", 500, false)
</script>
<br />
	...
	<tr valign="top">
		<td valign="top">
			<table><!--- inner table --->
				...
				<cfelse>
				<tr align="center" bgcolor="##FFE271">
					<th>#totalClassesByLocationRecordSet.july#</th>
					<th>Class Count</th>
				</tr>
				<cfloop query="totalClassesByLocationRecordSet.julyResults">
				<tr align="center" bgcolor="##FFF2BF">
		...
		<td valign="top">
			<table><!--- inner table --->
				...
				<cfelse>
				<tr align="center" bgcolor="##FFE271">
					<th>#totalClassesByLocationRecordSet.august#</th>
					<th>Class Count</th>
				</tr>
				<cfloop query="totalClassesByLocationRecordSet.augustResults">
				<tr align="center" bgcolor="##FFF2BF">
		...
		<td valign="top">
			<table><!--- inner table --->
				...
				<cfelse>
				<tr align="center" bgcolor="##FFE271">
					<th>#totalClassesByLocationRecordSet.september#</th>
					<th>Class Count</th>
				</tr>
				<cfloop query="totalClassesByLocationRecordSet.septemberResults">
				<tr align="center" bgcolor="##FFF2BF">
		...
		<td valign="top">
			<table><!--- inner table --->
				...
				<cfelse>
				<tr align="center" bgcolor="##FFE271">
					<th>#totalClassesByLocationRecordSet.october#</th>
					<th>Class Count</th>
				</tr>
				<cfloop query="totalClassesByLocationRecordSet.octoberResults">
				<tr align="center" bgcolor="##FFF2BF">
		...
		<td valign="top">
			<table><!--- inner table --->
				...
				<cfelse>
				<tr align="center" bgcolor="##FFE271">
					<th>#totalClassesByLocationRecordSet.november#</th>
					<th>Class Count</th>
				</tr>
				<cfloop query="totalClassesByLocationRecordSet.novemberResults">
				<tr align="center" bgcolor="##FFF2BF">
		...
		<td valign="top">
			<table><!--- inner table --->
				...
				<cfelse>
				<tr align="center" bgcolor="##FFE271">
					<th>#totalClassesByLocationRecordSet.december#</th>
					<th>Class Count;</th>
				</tr>
				<cfloop query="totalClassesByLocationRecordSet.decemberResults">
				<tr align="center" bgcolor="##FFF2BF">
	...
	<tr>
		<td valign="top">
			<table><!--- inner table --->
				...
				<cfelse>
				<tr align="center" bgcolor="##FFE271">
					<th>#totalClassesByLocationRecordSet.january#</th>
					<th>Class Count</th>
				</tr>
				<cfloop query="totalClassesByLocationRecordSet.januaryResults">
				<tr align="center" bgcolor="##FFF2BF">
		...
		<td valign="top">
			<table><!--- inner table --->
				...
				<cfelse>
				<tr align="center" bgcolor="##FFE271">
					<th>#totalClassesByLocationRecordSet.february#</th>
					<th>Class Count</th>
				</tr>
				<cfloop query="totalClassesByLocationRecordSet.februaryResults">
				<tr align="center" bgcolor="##FFF2BF">
		...
		<td valign="top">
			<table><!--- inner table --->
				...
				<cfelse>
				<tr align="center" bgcolor="##FFE271">
					<th>#totalClassesByLocationRecordSet.march#</th>
					<th>Class Count</th>
				</tr>
				<cfloop query="totalClassesByLocationRecordSet.marchResults">
				<tr align="center" bgcolor="##FFF2BF">
		...
		<td valign="top">
			<table><!--- inner table --->
				...
				<cfelse>
				<tr align="center" bgcolor="##FFE271">
					<th>#totalClassesByLocationRecordSet.april#</th>
					<th>Class Count</th>
				</tr>
				<cfloop query="totalClassesByLocationRecordSet.aprilResults">
				<tr align="center" bgcolor="##FFF2BF">
		...
		<td valign="top">
			<table><!--- inner table --->
				...
				<cfelse>
				<tr align="center" bgcolor="##FFE271">
					<th>#totalClassesByLocationRecordSet.may#</th>
					<th>Class Count</th>
				</tr>
				<cfloop query="totalClassesByLocationRecordSet.mayResults">
				<tr align="center" bgcolor="##FFF2BF">
		...
		<td valign="top">
			<table><!--- inner table --->
				...
				<cfelse>
				<tr align="center" bgcolor="##FFE271">
					<th>#totalClassesByLocationRecordSet.june#</th>
					<th>Class Count</th>
				</tr>
				<cfloop query="totalClassesByLocationRecordSet.juneResults">
				<tr align="center" bgcolor="##FFF2BF">
